...
void reiniciar()
{
  ...
  digitalWrite(11, HIGH); //LIGA LED AZUL
  delay(1000);
  digitalWrite(8, LOW); //DESLIGA LED VERMELHO
  digitalWrite(9, LOW); //DESLIGA LED VERDE
  digitalWrite(10, LOW); //DESLIGA LED AMARELO
...
{
  Serial.begin(9600);
  pinMode(2, INPUT_PULLUP); //LED VERMELHO
  pinMode(3, INPUT_PULLUP); //LED VERDE
  pinMode(4, INPUT_PULLUP); //LED AMARELO
  pinMode(5, INPUT_PULLUP); //LED AZUL

  pinMode(6, INPUT_PULLUP); //BOTÃO RESET

  pinMode(8, OUTPUT);  //BOTÃO LED VERMELHO
  pinMode(9, OUTPUT);  //BOTÃO LED VERDE
  pinMode(10, OUTPUT); //BOTÃO LED AMARELO
